...
<template>
  <header
    ...
    class="bg-surface-bright/95 backdrop-blur-md border-b border-surface-variant px-3.5 py-1.5 pt-safe flex items-center justify-between shadow-xs md:hidden transition-all"
  >
